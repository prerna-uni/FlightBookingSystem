...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        flightRepository.save(new Flight(null, "DEL", "MUM", "AI101", "2025-06-01", 50));
        flightRepository.save(new Flight(null, "DEL", "BLR", "AI102", "2025-06-01", 40));
        flightRepository.save(new Flight(null, "MUM", "DEL", "AI103", "2025-06-02", 60));
    }
}